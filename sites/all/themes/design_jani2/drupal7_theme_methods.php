...
function design_jani2_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function design_jani2_button($variables) {
 ...
 */
function design_jani2_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function design_jani2_menu_local_task($variables) {
 ...
 */
function design_jani2_feed_icon($variables) {
