...
function design_jani3_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function design_jani3_button($variables) {
 ...
 */
function design_jani3_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function design_jani3_menu_local_task($variables) {
 ...
 */
function design_jani3_feed_icon($variables) {
