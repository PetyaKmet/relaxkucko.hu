...
function design_jani_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function design_jani_button($variables) {
 ...
 */
function design_jani_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function design_jani_menu_local_task($variables) {
 ...
 */
function design_jani_feed_icon($variables) {
